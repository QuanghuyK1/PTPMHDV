...
#!perl
#line 29
    eval 'exec D:\xampp-windows-x64-7-3-30-0-VC15-installer (1).exe\xampp\perl\bin\perl.exe -S $0 ${1+"$@"}'
...
my $perlpath = 'D:\xampp-windows-x64-7-3-30-0-VC15-installer (1).exe\xampp\perl\bin\perl.exe';
