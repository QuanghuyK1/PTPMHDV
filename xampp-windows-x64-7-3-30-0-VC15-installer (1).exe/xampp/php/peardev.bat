...
FOR %%x IN ("D:\xampp-windows-x64-7-3-30-0-VC15-installer (1).exe\xampp\php\pear") DO (if %%x=="%PMTPMTPMT%" GOTO :NOTINSTALLED)

REM Check PEAR global ENV, set them if they do not exist
IF "%PHP_PEAR_INSTALL_DIR%"=="" SET "PHP_PEAR_INSTALL_DIR=D:\xampp-windows-x64-7-3-30-0-VC15-installer (1).exe\xampp\php\pear"
IF "%PHP_PEAR_BIN_DIR%"=="" SET "PHP_PEAR_BIN_DIR=D:\xampp-windows-x64-7-3-30-0-VC15-installer (1).exe\xampp\php"
IF "%PHP_PEAR_PHP_BIN%"=="" SET "PHP_PEAR_PHP_BIN=D:\xampp-windows-x64-7-3-30-0-VC15-installer (1).exe\xampp\php\php.exe"
GOTO :INSTALLED
